              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                      height: 10.0,
                      width: 30.0,
                      color: clsThemes.getColor(cls_setting.color)
                  ),
                )
                ,
                const Icon(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buyAction
                          , child: Text('Buy'),style: ButtonStyle(backgroundColor: MaterialStateProperty.all(clsThemes.getColor(cls_setting.color)))),
                      SizedBox(width: 10.0,),
                      ElevatedButton(onPressed:
                      restoreAction
                          , child: Text('Restore'),style: ButtonStyle(backgroundColor: MaterialStateProperty.all(clsThemes.getColor(cls_setting.color)))),
                    ],
                  ),
                )
              ],
